...
<body>
    ...
    角色名: <input type="text" value="${param.rolename}" id="rolename" name="rolename" class="easyui-textbox">
    角色描述: <input type="text" id="roledesc" value="${param.roledesc}" name="roledesc" class="easyui-textbox">
    <a href="javascript:void(0)" id="confirmRoleAdd" class="easyui-linkbutton c8" style="width:120px">确认修改</a>
